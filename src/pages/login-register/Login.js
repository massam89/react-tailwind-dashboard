...
const Login = () => {
  ...
  return (
    <div className={`bg-[#13346e] xs:bg-white  h-full w-full xs:w-1/2 absolute ${isLoginMode ? 'right-0 xs:right-[50%] opacity-100 z-10' : 'xs:right-0 right-[-50%] opacity-0 -z-10'} transition-all duration-1000 flex justify-center items-center`}>
      <div className="w-3/4">
