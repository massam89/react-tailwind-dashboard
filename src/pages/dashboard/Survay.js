...
const Survay = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:flex-wrap md:flex-row md:flex-nowrap items-center sm:justify-center md:items-stretch md:justify-between sm:space-x-2 pt-3 px-6">
        ...
        <div className="flex items-center justify-around sm:justify-around py-5 mb-3 md:justify-between bg-white hover:shadow-lg hover:shadow-green-300 border-2 border-transparent hover:border-2 hover:border-green-300 box-content transition-color duration-200 w-full sm:w-[calc(50%-15px)] md:p-3 lg:py-4 rounded-lg shadow-xl">
            <div className="flex flex-col">
        ...
        <div className="flex items-center justify-around sm:justify-around py-5 mb-3 md:justify-between bg-white hover:shadow-lg hover:shadow-yellow-300 border-2 border-transparent hover:border-2 hover:border-yellow-300 box-content transition-color duration-200 w-full sm:w-[calc(50%-15px)] md:p-3 lg:py-4 rounded-lg shadow-xl">
            <div className="flex flex-col">
        ...
        <div className="flex items-center justify-around sm:justify-around py-5 mb-3 md:justify-between bg-white hover:shadow-lg hover:shadow-red-300 border-2 border-transparent hover:border-2 hover:border-red-300 box-content transition-color duration-200 md:p-3 w-full sm:w-[calc(50%-15px)] lg:py-4 rounded-lg shadow-xl">
            <div className="flex flex-col">
