...
const FormInput = (props) => {
  ...
  return (
    <div className="relative mb-4 w-full">
      ...
      {props.type === 'password' ? <input className="pl-8 pb-5 border-b-2 border-gray-200 outline-none mx-auto block text-gray-400 w-full" {...makenewprops(props)}  /> : <input className="pl-8 pb-5 border-b-2 border-gray-200 outline-none mx-auto block text-gray-400 w-full" {...makenewprops(props)} /> }
    </div>
  );
};
